...
mod tests {
    ...
    use crate::assembler::syntax::actions::mock::IdentKind::*;
    use crate::assembler::syntax::actions::mock::*;
    use crate::diagnostics::{CompactDiag, Merge, Message};
    ...
    pub(super) type MockSpan = crate::diagnostics::MockSpan<TokenRef>;
