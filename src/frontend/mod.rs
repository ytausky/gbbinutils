...
use crate::span::{BufContext, ContextFactory, MacroContextFactory, MacroExpansionContext, Span};
...
trait MacroTable<I, F: MacroContextFactory>
where
    Self: Get<I>,
...
trait Expand<I, F: MacroContextFactory> {
