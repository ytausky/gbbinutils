...
pub(super) type LabelSemantics<R, N> = Session<R, N, LabelState<R>>;
...
impl<R: ReentrancyActions, N> LabelActions<R::Ident, R::Span> for LabelSemantics<R, N> {
    type Next = InstrLineSemantics<R, N>;
